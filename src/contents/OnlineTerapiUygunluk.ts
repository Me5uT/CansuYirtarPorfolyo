...
export const OnlineTerapiUygunluk: IContentModel = {
  ...
  Düzenli olarak geleneksel danışmanlık istemeyenler Bir terapi merkezine gitmeye çekiniyorsanız.
  
  Zaman ve mekan kısıtlaması olmadığı için online terapi oldukça geniş bir yelpazeye hitap eder.
  
  Bir terapi merkezine gitmeye çekiniyorsanız.
  
  Ufak çocuğunu evde bırakamayan ebeveynler.
  
  Çok sık seyahat eden bireyler.
  
  Açık alan korkusuna sahip hastalar.
  
  Yoğun çalışma programı olanlar.
  
  Yurtdışında yaşayan ve kendi ana dilini konuşan bir uzmandan terapi almak isteyen Türk vatandaşları.
